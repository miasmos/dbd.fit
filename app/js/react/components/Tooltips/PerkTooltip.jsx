...
export const PerkTooltip = ({ perk }) => {
    ...
    const subtitle = `${rarity} ${i18n.text.perk}`;
    ...
    return (
        <div className="tooltip tooltip-detailed perk-tooltip">
            <div className={`tooltip-banner tier${perk.tier} ${rarityClass}`}>
                ...
                <div className="ticks">
                    <img className="tick tick1" src="images/Point_Tick.png" />
                    <img className="tick tick2" src="images/Point_Tick.png" />
                    <img className="tick tick3" src="images/Point_Tick.png" />
                </div>
            </div>
