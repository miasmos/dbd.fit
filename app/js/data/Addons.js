const KillerAddons = {
	...
	WRAITH: {
		...
		BLINK_SOOT: {
			...
			name: '"Blink" - Soot',
			rarity: 'COMMON',
			description: 'The Kratin symbol, represting quick passing, is finger-drawn in soot on the body of the Bell.\nSlightly reduces the Bell\'s disappearance time.',
			image: 'images/Addon_WoodenHorse.png'
		},
		BLIND_WARRIOR_SOOT: {
		...
		WINDSTORM_SOOT: {
			index: 'WINDSTORM_SOOT',
			name: '"Windstorm" - Soot',
			rarity: 'UNCOMMON',
			description: 'The Ohuwe-Onmnea symbol, representing a violent storm, is finger-drawn in soot on the body of the Bell.\nGrants a boost to movement speed for 0.5 second after reappearing.',
			image: 'images/Addon_WoodenHorse.png'
		},
		SWIFT_HUNT_MUD: {
		...
		BLINK_MUD: {
			...
			name: '"Blink" - Mud',
			rarity: 'UNCOMMON',
			description: 'The Kratin symbol, represting quick passing, is finger-drawn in mud on the body of the Bell.\nModerately reduces the Bell\'s disappearance time.',
			image: 'images/Addon_WoodenHorse.png'
		},
		BLIND_WARRIOR_MUD: {
		...
		THE_GHOST_SOOT: {
			index: 'THE_GHOST_SOOT',
			name: '"The Ghost" - Soot',
			rarity: 'RARE',
			description: 'The Khugwemuu symbol, representing the spirit world, is finger-drawn in soot on the body of the Bell.\nGrants stealth when uncloaking while motionless.\nStealth reduces your terror radius to 0m until you move or act again.',
			image: 'images/Addon_WoodenHorse.png'
		},
		SWIFT_HUNT_WHITE: {
	...
	SHAPE: {
		...
		BOYFRIENDS_MEMO: {
			...
			rarity: 'COMMON',
			description: 'A "romantic", if slightly sleazy, note left around to draw the attention of a female lover.\nSlightly increases the lunge of Evil Within I.',
		...
		J_MYERS_MEMORIAL: {
			...
			rarity: 'RARE',
			description: 'A glossy page ripped from the 1965 Haddonfield High School yearbook, one dedicated to the memory of Judith Myers.\nModerately increases the rate at which evil is gained when stalking a Survivor.',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		HAIR_BOW: {
			index: 'HAIR_BOW',
	...
	DOCTOR: {
		...
		INTERVIEW_TAPE: {
			...
			name: 'Interview Tape',
			rarity: 'UNCOMMON',
			description: 'A compact cassette from Project Awakening containing an un-edited interview of a victim. Opens The Doctor\'s mind to alternate treatment methods.\nShock Therapy area of effect becomes a beam with a 20m range and a 2m width.',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		RESTRAINT_CLASS_II: {
		...
		CALM_CLASS_II: {
			...
			flavor: 'Electro-convulsive therapy is one of the safest medical procedures." — Léry\'s Memorial Institute',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		...
		RESTRAINT_CARTERS_NOTES: {
			...
			flavor: '"I CAN SEE THEIR DISGUSTING ILLNESSES ." — Unsigned Notes (potentially Herman Carter)',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		ORDER_CARTERS_NOTES: {
			...
			flavor: '"The stimulus must be kept active at a convulsive level." — Herman Carter',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		OBEDIENCE_CARTERS_NOTES: {
			...
			flavor: '"BREAK THEIR IMPURE BODIES" — Unsigned Notes (potentially Herman Carter)',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		...
		CALM_CARTERS_NOTES: {
			...
			flavor: '"Higher quality seizures trigger catatonia. At least it gives me peace for the time it lasts." — Herman Carter',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		IRIDESCENT_KING: {
	...
	HUNTRESS: {
		...
		OAK_HAFT: {
			...
			name: 'Oak Haft',
			rarity: 'UNCOMMON',
			description: 'A polished haft which allows for a quick and sly manipulation of the deadly tool.\nModerately decreases cooldown time between Hatchet throws.',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		MANNA_GRASS_BRAID: {
		...
		IRIDESCENT_HEAD: {
			...
			rarity: 'ULTRA_RARE',
			description: 'A glass-like Hatchet head molded from The Fog itself. The blade is warm and reverberating with The Entity\'s power.\nInflicts dying upon the victim.\nReduces maximum carried Hatchet amount by 4.',
	...
	NIGHTMARE: {
		...
		PILL_BOTTLE: {
			...
			name: 'Pill Bottle',
			rarity: 'VERY_RARE',
			description: 'An empty pill bottle which once contained a medicine called "Zoneral".\nSurvivors do not see glimpses of you during the Dream Transition.',
			image: 'images/Addon_BadMansLastBreath.png'
		},
		PAINT_THINNER: {
			index: 'PAINT_THINNER',
